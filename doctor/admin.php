<?php
    ...
    echo '<tr><td class = "unique_case" colspan=4><a class="sign_news">* 0 = visiteur, 1 = P\'tit Dub, 2 = Gros Dub solo, 3 = Gros Dub tribu, 4 = Étudiant-parasite, 5 = Membre d\'honneur</a></td></tr>';
    echo '</form></table>';
?>